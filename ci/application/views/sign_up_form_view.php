...
<head lang="en">
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>css/sign_up_style.css"/> <!-- link to external css file -->
...
<div id="sign_up_form">
    ...
    <form id="main_page_sign_up_form" action="<?php echo base_url();?>index.php/main_webpage/user_sign_up" method="POST">
        ...
        <div class="first_box_element_signup_page">
            <div class="on_top">
        ...
        <div id="last_name_signup_page">
            <div class="on_top">
                <label for="lname">Last Name</label><span class="asterisk_red">*</span>
            </div>
        ...
        <div class="first_box_element_signup_page">
            <div class="on_top">
                <label for="mycity_shipping">City</label><span class="asterisk_red">*</span>
            </div>
        ...
        <div class="first_box_element_signup_page">
            <div class="on_top">
                <label for="mystate_shipping">State</label><span class="asterisk_red">*</span>
            </div>
            <input type="text" id="mystate_shipping" name="state_shipping" maxlength="2" size="2" pattern="[A-Za-z]{2}" required/>
        </div>

        <div id="country_shipping_signup_page">
            <div class="on_top">
                <label for="mycountry_shipping">Country</label><span class="asterisk_red">*</span><br>
            </div>
        ...
        <div class="second_box_element_signup_page">
            <div class="on_top">
        ...
        <div id="security_signup_page">
            <div class="on_top">
                <label for="mysecuritycode">Security Code</label><span class="asterisk_red">*</span><br>
            </div>
            <input type="text" id="mysecuritycode" name="mysecuritycode" pattern ="[0-9]{3}" size="3" maxlength="3" required/><br><br>
        </div>
        ...
        <div id="exp_year_signup_page">
            <div class="on_top">
                <label for="myexpiredate_year">Expiration date year</label><span class="asterisk_red">*</span><br>
            </div>
            <input type="text" id="myexpiredate_year" name="myexpiredate_year" pattern ="[0-9]{4}" size="4" maxlength="4" required/><br><br>
        </div>
        ...
        <div class="first_box_element_signup_page">
            <div class="on_top">
                <label for="mycity_billing">City</label><span class="asterisk_red">*</span>
            </div>
        ...
        <div class="first_box_element_signup_page">
            <div class="on_top">
                <label for="mystate_billing">State</label><span class="asterisk_red">*</span>
            </div>
            <input type="text" id="mystate_billing" name="state_billing" maxlength="2" size="2" pattern="[A-Za-z]{2}" required/>
        </div>

        <div id="country_billing_signup_page">
            <div class="on_top">
                <label for="mycountry_billing">Country</label><span class="asterisk_red">*</span><br>
            </div>
        ...
        <div id="email_signup_page">
            <div class="on_top">
                <label for="myemail">Email</label><span class="asterisk_red">*</span><br>
            </div>
            <input type="email" id="myemail" name="email_addr" maxlength="40" pattern="[A-Za-z0-9]+@[A-Za-z0-9]+\.[a-z]{2,3}$" required/><br><br>
        </div>
        ...
        <div id="pwd_signup_page">
            <div class="on_top">
                <label for="pwd">Password</label><span class="asterisk_red">*</span><br>
            </div>
